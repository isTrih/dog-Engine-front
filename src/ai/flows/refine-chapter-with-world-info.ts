...
const RefineChapterWithWorldInfoInputSchema = z.object({
	...
	worldInfo: z
		.string()
		.optional()
		.describe("The world information to use for refining the chapter."),
	characterCards: z
		.string()
		.optional()
		.describe("The character cards to use for refining the chapter."),
	aiRole: z
		.string()
		.optional()
		.describe("The role of the AI in refining the chapter."),
});
...
const DeconstructOutlineInputSchema = z.object({
	chapterContent: z
		.string()
		.describe("The content of the chapter to deconstruct."),
	model: z.string().optional().describe("The model to use for the response."),
});
export type DeconstructOutlineInput = z.infer<
	typeof DeconstructOutlineInputSchema
>;

const DeconstructOutlineOutputSchema = z.object({
	outline: z.string().describe("The generated outline."),
});
export type DeconstructOutlineOutput = z.infer<
	typeof DeconstructOutlineOutputSchema
>;
